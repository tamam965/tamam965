...
<form method="post">
    ...
    if(@$_POST['input']){
        ...
        $query1=mysqli_query($GLOBALS["___mysqli_ston"], "insert into tb_pengguna(username, pass, status) values('$username','$pass', '$status')") or die (mysqli_error($GLOBALS["___mysqli_ston"]));

        $query=mysqli_query($GLOBALS["___mysqli_ston"], "insert into tb_guru(nip, nama_guru, kode_guru, jenis_kelamin, tempat_lahir, tanggal_lahir, alamat, agama) 
