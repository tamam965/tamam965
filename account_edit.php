...
<div class="row">
    <div class="col-lg-5">
        ...
        <?php
            $id = @$_GET['id'];
            $qrykoreksi=mysqli_query($GLOBALS["___mysqli_ston"], "select * from tb_pengguna where id_pengguna='$id'");
        ...
        if(@$_POST['edit']){
            ...
            $query=mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE tb_pengguna SET username='$username', pass='$pass'  WHERE id_pengguna='$id'") or die (mysqli_error($GLOBALS["___mysqli_ston"]));
