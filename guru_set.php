...
<div class="row">
    <div class="col-lg-5">
        ...
        <form method="post">
            <div class="form-group">
                ...
                <select name="kode_guru" class="form-control" required>
                    ...
                    <?php 
                        $query=mysqli_query($GLOBALS["___mysqli_ston"], "select * from tb_guru order by nip asc");
            ...
            <div class="form-group">
                ...
                <select name="kode_mapel" class="form-control" required>
                    ...
                    <?php 
                        $query=mysqli_query($GLOBALS["___mysqli_ston"], "select * from tb_mapel order by kode_mapel asc");
                        while($row=mysqli_fetch_array($query))
                        {
                    ?>
        ...
        if(@$_POST['input']){
            ...
            $query=mysqli_query($GLOBALS["___mysqli_ston"], "insert into tb_mengajar(kode_guru, kode_mapel) values('$kode_guru','$kode_mapel')") or die (mysqli_error($GLOBALS["___mysqli_ston"]));
    ...
    <div class="col-lg-7">
        ...
        <div class="table-responsive">
            <?php
                $view=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT tb_guru.nama_guru, tb_mengajar.id_mengajar, tb_mapel.mapel from tb_guru, tb_mengajar, tb_mapel 
