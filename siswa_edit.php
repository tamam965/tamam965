...
<div class="row">
    ...
    <?php
        $id = $_GET['id'];
        $qrykoreksi=mysqli_query($GLOBALS["___mysqli_ston"], "select * from tb_siswa where id_siswa='$id'");
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                <select name="kelas" class="form-control" required>
                    ...
                    <?php 
                        $query=mysqli_query($GLOBALS["___mysqli_ston"], "select * from tb_kelas order by kelas asc");
...
<div class="row">
    ...
    if(@$_POST['edit']){
        ...
        $query=mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE tb_siswa SET nis='$nis', nama_siswa='$nama_siswa', jenis_kelamin='$jenis_kelamin',
                            tempat_lahir='$tempat_lahir', tanggal_lahir='$tanggal_lahir', alamat='$alamat', agama='$agama',
                            nama_ortu='$nama_ortu', no_ortu='$no_ortu', id_kelas='$kelas' WHERE id_siswa='$id'") or die (mysqli_error($GLOBALS["___mysqli_ston"]));
