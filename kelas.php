...
<div class="row">
    <div class="col-lg-5">
        ...
        if(@$_POST['input']){
            ...
            $query=mysqli_query($GLOBALS["___mysqli_ston"], "insert into tb_kelas(kelas) values('$kelas')") or die (mysqli_error($GLOBALS["___mysqli_ston"]));
    ...
    <div class="col-lg-7">
        ...
        <div class="table-responsive">
            <?php
                $view=mysqli_query($GLOBALS["___mysqli_ston"], "select * from tb_kelas order by kelas asc");
                $no=0;
            ?>
