...
<div class="row">
    <div class="col-lg-5">
        ...
        <?php
            $id = @$_GET['id'];
            $qrykoreksi=mysqli_query($GLOBALS["___mysqli_ston"], "select * from tb_kelas where id_kelas='$id'");
        ...
        if(@$_POST['edit']){
            ...
            $query=mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE tb_kelas SET kelas='$kelas' WHERE id_kelas='$id'") or die (mysqli_error($GLOBALS["___mysqli_ston"]));
